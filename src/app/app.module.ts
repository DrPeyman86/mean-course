...
import { PostCreateComponent } from './posts/post-create/post-create.component';//import the component you want to register first
...
@NgModule({
  ...
  imports: [
    BrowserModule,
    FormsModule//add the FormsModule directives package inside here
  ],
  providers: [],
